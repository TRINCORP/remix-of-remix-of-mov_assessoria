    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-12 text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          >
            <span className="block text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black leading-[0.95] tracking-tight text-foreground section-title-animate">
